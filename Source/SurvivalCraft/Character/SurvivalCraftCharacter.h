...
UCLASS(config=Game)
class ASurvivalCraftCharacter : public ACharacter,public ISCCharacter
{
	GENERATED_BODY()
	...
	TObjectPtr<USCPlayerInventory> SCPlayerInventory;

	UPROPERTY(visibleAnywhere, BlueprintReadOnly, Category = Inventory, meta = (AllowPrivateAccess = "true"))
	TObjectPtr<USCPlayerHotBar> SCPlayerHotBar;
...
public:
	...
	virtual ASurvivalCraftCharacter* GetCharacter() override;
